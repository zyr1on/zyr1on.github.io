...
const translations = {
  en: {
    ...
    cert1_title: "Junior Penetration Tester",
    cert1_date:  "January 2026",
    cert2_title: "Certified Web Security Expert",
    cert2_date:  "September 2025",
    cert3_title: "Certified Associate Penetration Tester",
    cert3_date:  "July 2025",
    cert4_title: "API Penetration Testing",
    cert4_date:  "July 2025",
  ...
  tr: {
    ...
    about_p2: "Siber güvenlik, ağ güvenliği ve oyun geliştirme alanlarında aktif olarak kendini geliştiriyor. Düşük seviye sistem mimarisi, bilgisayar grafikleri ve otomasyona olan tutkusu büyük.",
    about_p3: "Teknik bilgisini gerçek dünya projelerinde uygulamak için hevesli, takım çalışmasına yatkın bir yazılımcı.",

    stat_gpa:      "Not Ortalaması",
    stat_projects: "Proje",
    ...
    proj1_desc: "C++20 ile sıfırdan yazılmış gerçek zamanlı 3B render motoru. Bindless texture, PBR materyal pipeline, UBO tabanlı kamera/ışık, Poisson disk gölge haritalama ve yerleştirilebilir ImGui editörü içerir.",
    proj2_sub:  "Zararlı Yazılım Analiz Çerçevesi",
    proj2_desc: "ELF ve PE ikili dosyaları için statik zararlı yazılım analiz aracı. LIEF kütüphanesiyle dosyaları ayrıştırır, çalıştırmadan şüpheli API çağrılarını ve IOC göstergelerini tespit eder.",
    ...
    cert1_title: "Junior Penetration Tester",
    cert1_date:  "Ocak 2026",
    cert2_title: "Certified Web Security Expert",
    cert2_date:  "Eylül 2025",
    cert3_title: "Certified Associate Penetration Tester",
    cert3_date:  "Temmuz 2025",
    cert4_title: "API Penetration Testing",
    cert4_date:  "Temmuz 2025",

    contact_desc: "Staj, iş birliği ve ilginç projelere açığım.",

    typed_messages: [
      "staja hazırım...",
      "bir şeyler inşa ediyorum...",
      "sisteme sızıyorum...",
      "dünyaları render ediyorum...",
    ],
  },
};
...
function applyLang(lang) {
  ...
  // restart typed effect with new messages
...
function typeEffect() {
  ...
  setTimeout(typeEffect, typedDeleting ? 45 : 80);
}
typeEffect();
